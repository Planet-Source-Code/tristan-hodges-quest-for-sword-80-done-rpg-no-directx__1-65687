...
Case "Buy Item"
    If Gold < lCost Then
        MsgBox "I'm afraid you don't have enough gold to purchase this item.  Sooo sorry."
        Exit Sub
    End If
    Gold = Gold - SelCost
